...
This vendored copy is adapted for multi-agent use. Default operation should not
send file contents to Anthropic or invoke the Claude CLI. Use the upstream
scripts only as an explicit opt-in backend after the user accepts that data
boundary.
