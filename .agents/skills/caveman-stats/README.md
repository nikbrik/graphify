...
This skill is Claude-hook compatibility only. The graphify repo-local install
does not install caveman hooks, so non-Claude agents must report stats as
unavailable instead of estimating savings.
